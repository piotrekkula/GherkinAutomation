...
{
    /// <summary>
    /// Class representing Adding new Single HCP Form page and all actions that can be performed on it. 
    /// </summary>

    public class AddNewsHCPFormPageModel : AddNewHCPFormPageModel, IHasSaveButton, IHasCancelButton, IHasSmokeTest
    {
        ...
        public readonly By lineMgrNameLookupButtonSelector = By.XPath("//label[contains(text(),'Line Manager')]/../../../td[2]/span/a");

        //Healthcare Professional Details selectors
        public static readonly By hcpDetailsOpenHCPListButtonSelector = By.XPath("//label[contains(text(),'HCP Country')]/../../../tr[2]/td[2]/input");
        ...
        /// </summary>
        public AddNewsHCPFormPageModel(IWebDriver driver)
        ...
        public void SmokeTest()
        {
            ...
            Assert.AreEqual(formTypesHCP, Driver.FindElement(infoFormTypeLabelSelector).Text, "Smoke test failed. Object " + infoFormTypeLabelSelector + " cannot be found on page!");
        ...
        public override void FillInEngagementDescriptionSection(string engagementTitle, string engagementCongress, string engagementType, string allDayEngagement, string engagementVenue, string engagementCity, string engagementCountry, string engagementStateProvince, string sciMedBusNeeds, string engagementObjective, string contractedService, string engagementDescription)
        {
            ...
            //We could not establish why this happens. Maybe difference between browser and actual driver server we use. To be used after it is fixed.
        ...
        {
            //Healthcare Professional Details assertions
            Assert.AreEqual(hcpDetailsCountry, Driver.FindElement(hcpDetailsCountryOptionFieldSelector).Text, "HCP Details Country field incorrect!");
            Assert.AreEqual(hcpFirstName, Driver.FindElement(hcpDetailsFirstNameLabelSelector).Text, "HCP Details First Name should be filled!");
            Assert.AreEqual(hcpLastName, Driver.FindElement(hcpDetailsLastNameLabelSelector).Text, "HCP Details Last Name should be filled!");
        }
