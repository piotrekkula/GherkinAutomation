...
{
    /// <summary>
    /// Class representing View sHCP page when user creates new form and all actions that can be performed on it. 
    /// </summary>

    public class ViewsHCPFormPageModel : ViewHCPFormPageModel, IHasEditButton, IHasCancelButton, IHasSendForVerificationButton
    {
        //Healthcare Professional Details selectors
        public static readonly By hcpDetailsCountryFieldSelector = By.XPath("//h3[contains(text(),'Healthcare Professional Details')]/../../../div[5]/div[2]/table/tbody/tr/td[3]/span/a");
        public static readonly By hcpDetailsFirstNameLabelSelector = By.XPath("//h3[contains(text(),'Healthcare Professional Details')]/../../../div[5]/div[2]/table/tbody/tr[3]/td[4]/span");
        public static readonly By hcpDetailsLastNameLabelSelector = By.XPath("//h3[contains(text(),'Healthcare Professional Details')]/../../../div[5]/div[2]/table/tbody/tr[4]/td[4]/span");

        /// <summary>
        /// Constructor used when object of child class instantiated.
        /// </summary>
        public ViewsHCPFormPageModel(IWebDriver driver)
        ...
        public override void VerifyIfHCPDetailsSectionIsSaved(string hcpCountry, string hcpFirstName, string hcpLastName, string hcpFirstName2 = "", string hcpLastName2 = "")
        {
            ...
            Assert.AreEqual(hcpCountry, Driver.FindElement(hcpDetailsCountryFieldSelector).Text, "HCP Country field is incorrect!");
            Assert.AreEqual(hcpFirstName, Driver.FindElement(hcpDetailsFirstNameLabelSelector).Text, "HCP First Name field is incorrect!");
            Assert.AreEqual(hcpLastName, Driver.FindElement(hcpDetailsLastNameLabelSelector).Text, "HCP LastName field is incorrect!");
        }
